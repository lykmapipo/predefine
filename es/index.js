import { sortedUniq, abbreviate, pkg } from '@lykmapipo/common';
import { getString, getStrings, apiVersion as apiVersion$1 } from '@lykmapipo/env';
import { Router, getFor, schemaFor, postFor, getByIdFor, patchFor, putFor, deleteFor } from '@lykmapipo/express-rest-actions';

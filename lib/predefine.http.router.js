 ...
 */
router.get(PATH_LIST, function getPredefines(request, response, next) {

  // obtain request options
  const options = _.merge({}, request.mquery);

  Predefine
    .get(options, function onGetPredefines(error, results) {
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.post(PATH_LIST, function postPredefine(request, response, next) {

  //obtain request body
  const body = _.merge({}, request.body);

  Predefine
    .post(body, function onPostPredefine(error, created) {
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.get(PATH_SINGLE, function getPredefine(request, response, next) {
  ...
  Predefine
    .getById(options, function onGetPredefine(error, found) {
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.patch(PATH_SINGLE, function patchPredefine(request, response, next) {
  ...
  Predefine
    .patch(id, patches, function onPatchPredefine(error, patched) {
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.put(PATH_SINGLE, function putPredefine(request, response, next) {
  ...
  Predefine
    .put(id, patches, function onPutPredefine(error, updated) {
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.delete(PATH_SINGLE, function deletePredefine(request, response, next) {
  ...
  Predefine
    .patch(_id, patches, function onDeletePredefine(error, deleted) {

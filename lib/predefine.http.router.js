...
/* middleware to handle request bucket */
const handleBucket = (request, response, next) => {
  // extend mquery with bucket filter
  const { bucket } = request.params;
  const bucketFilter = { filter: { bucket } };
  request.mquery = mergeObjects(bucketFilter, request.mquery);

  // extend body with bucket
  request.body = mergeObjects({ bucket }, request.body);
 ...
 */
router.get(PATH_LIST, handleBucket, getFor({
 ...
 * @apiUse RequestHeaders
 */
router.get(PATH_SCHEMA, handleBucket, schemaFor({
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.post(PATH_LIST, handleBucket, postFor({
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.get(PATH_SINGLE, handleBucket, getByIdFor({
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.patch(PATH_SINGLE, handleBucket, patchFor({
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.put(PATH_SINGLE, handleBucket, putFor({
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.delete(PATH_SINGLE, handleBucket, deleteFor({

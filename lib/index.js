...
const stringSchemaPaths = () =>
  common.sortedUniq([
    ...
    ...env.getStringSet('PREDEFINE_STRINGS', []),
  ]);
...
const numberSchemaPaths = () =>
  common.sortedUniq([
    ...
    ...env.getStringSet('PREDEFINE_NUMBERS', []),
  ]);
...
const booleanSchemaPaths = () =>
  common.sortedUniq([
    ...
    ...env.getStringSet('PREDEFINE_BOOLEANS', []),
  ]);
...
const createDatesSchema = () => {
  ...
  const dates = common.sortedUniq([...env.getStringSet('PREDEFINE_DATES', [])]);
